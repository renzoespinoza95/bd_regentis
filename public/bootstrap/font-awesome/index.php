...
<head>
  ...
  <title>Font Awesome 4.7 - Bootstrap 2.3.2 Demo</title>
...
<body>
  <div class="container">
    <div class="page-header">
      <h1>Font Awesome 4.7 with Bootstrap 2.3.2</h1>
      <p class="lead">Todos los íconos disponibles con Font Awesome 4.7</p>
    </div>
    <div class="row">
      <div class="row">
  ...
  <!-- Bootstrap JS (opcional para funcionalidades JS) -->
